...
const SENSOR_META = {
  16:  { icon: 'pir',   label: 'PIR',     color: '#f59e0b' },
  32:  { icon: 'thm',   label: 'Thermal', color: '#f43f5e' },
  64:  { icon: 'geo',   label: 'Seismic', color: '#22d3ee' },
  128: { icon: 'tof',   label: 'ToF',     color: '#8b5cf6' },
  256: { icon: 'irb',   label: 'IR Beam', color: '#10b981' },
};
...
const ICON_SVG = {
  pir:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 2v20M2 12h20"/></svg>',
  thm:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"/></svg>',
  geo:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12h3l2-6 3 12 3-9 2 5 3-3h4"/></svg>',
  tof:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12c2-4 6-6 10-6s8 2 10 6c-2 4-6 6-10 6s-8-2-10-6z"/></svg>',
  irb:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg>',
};
